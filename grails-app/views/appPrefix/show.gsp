...
<html>
    ...
    <body>
        ...
        <div id="show-appPrefix" class="content scaffold-show" role="main">
            ...
            <f:display bean="appPrefix" />
            <g:form resource="${this.appPrefix}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.appPrefix}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
