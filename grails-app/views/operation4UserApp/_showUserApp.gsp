...
<html>
    ...
    <body>
        ...
        <div id="show-userApp" class="content scaffold-show" role="main">
            ...
            <f:display bean="userApp" />
            <g:form resource="${this.userAppList}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.userApp}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
