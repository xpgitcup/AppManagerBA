...
<html>
    ...
    <body>
        ...
        <div id="show-appRole" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.appRole}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.appRole}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
